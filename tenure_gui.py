...
import tenure_months_calculator as tmc
...
class App:
    ...
    def _build_ui(self):
        ...
        # —— 操作区 ——
        btn_frm = ttk.Frame(self.root, padding=(10, 0))
        ...
        # —— 日志区 ——
        ttk.Label(self.root, text="日志：").pack(anchor=tk.W, padx=10)
        self.log = scrolledtext.ScrolledText(self.root, height=26, state=tk.DISABLED,
                                             font=("Consolas", 9))
    ...
    def _start(self):
        ...
        threading.Thread(target=self._worker, args=(path, stat_month, raw_asof), daemon=True).start()
        self.root.after(80, self._poll)

    def _worker(self, input_file: str, stat_month: str, raw_asof: str):
